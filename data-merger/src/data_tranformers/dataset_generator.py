...
output_folder = "resources/dataset/"
vector_file_path = output_folder + "vector.json"
csv_output_file = output_folder + "dataset.csv"
output_filename = output_folder + "final_data.csv"
...
def dataset():
    ...
    with open(csv_output_file, "r") as csv_file, open(output_filename, "w") as json_output_file:
        ...
        for row in csv_reader:
            ...
            date = convert_date_format(date_time_str, "%Y-%m-%d %H:%M:%S", "%Y-%m-%d")
...
def convert_date_format(date_string, input_format, output_format):
    ...
    formatted_date = datetime_object.strftime(output_format)
